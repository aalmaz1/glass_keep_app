          ...
          ListView(
            ...
            children: [
              ...
              _buildOption(
                ...
                () => onThemeChanged(AppColors.obsidianDark, [AppColors.accentBlue, AppColors.accentIndigo, AppColors.accentDeepPurple], null),
              ),
              _buildOption(
                context,
                'Deep Sea (Teal/Indigo)',
                CupertinoIcons.drop_fill,
                () => onThemeChanged(AppColors.obsidianDark, [AppColors.accentTeal, AppColors.accentIndigo, AppColors.accentBlue], null),
              ),
              _buildOption(
                context,
                'Cosmic (Purple/Indigo)',
                CupertinoIcons.sparkles,
                () => onThemeChanged(AppColors.obsidianDark, [AppColors.accentDeepPurple, AppColors.accentIndigo, AppColors.accentBlue], null),
              ),
              _buildOption(
                context,
                'Aurora (Green/Teal)',
                CupertinoIcons.wind,
                () => onThemeChanged(AppColors.obsidianDark, [AppColors.accentTeal, Colors.greenAccent, AppColors.accentBlue], null),
              ),
              _buildOption(
                context,
                'Electric (Blue/Red)',
                CupertinoIcons.bolt_fill,
                () => onThemeChanged(AppColors.obsidianDark, [AppColors.accentBlue, AppColors.accentRed, AppColors.accentIndigo], null),
              ),
